            ...
            tools: [
                {
                    ...
                    description: "Post a text message to a Google Chat space via a provided webhook URL.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            webhook: {
                                type: "string",
                                description: "The full Google Chat webhook URL (e.g., https://chat.googleapis.com/v1/spaces/AAAA.../messages?key=YOUR_KEY&token=YOUR_TOKEN).",
                            },
                            text: {
                                type: "string",
